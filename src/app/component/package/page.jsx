...
const Package = ({priceUSD, priceEGP, name,fet1,fet2,fet3,fet4,fet5,fet6,fet7,fet8}) => {
  ...
  return (
    <div className='w-[30%]  h-max pb-5 items-center bg-white rounded-[20px] border-gray-400 border-solid border-[1px] flex flex-col gap-[10px] max-460:w-[90%] max-770:w-[65%] max-1025:w-[40%] max-1440:w-[38%] '>
